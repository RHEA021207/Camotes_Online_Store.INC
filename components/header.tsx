      ...
      <div className="container mx-auto flex flex-wrap min-h-16 items-center justify-between gap-x-4 gap-y-2 px-4 py-2 md:py-0">
        ...
        <div className="flex items-center flex-shrink-0">
          {showBackButton ? (
            <Button
              variant="ghost"
              className="text-[#e0fbfc] hover:text-[#98c1d9] hover:bg-[#3d5a80] text-sm px-3"
        ...
        <div className="flex items-center gap-2 ml-auto md:ml-0 md:pr-44 transition-all duration-300">
          ...
          <div className="flex items-center gap-1.5 border-l border-[#3d5a80] pl-2 lg:pl-4">
            <Button
              variant="ghost"
              size="icon"
              className="relative text-[#e0fbfc] hover:text-[#98c1d9] hover:bg-[#3d5a80] h-9 w-9"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-[#e0fbfc] hover:text-[#98c1d9] hover:bg-[#3d5a80] h-9 w-9"
                >
          ...
          <Button
            variant="ghost"
            size="icon"
            className="md:hidden text-[#e0fbfc] h-9 w-9 hover:bg-[#3d5a80]"
